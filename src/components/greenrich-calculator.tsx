                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-grow">
                             <FormField
                                ...
                                <FormItem className="flex flex-col md:col-span-2">
                                  ...
                                  <Popover open={popoverOpenState[index]} onOpenChange={(open) => handlePopoverOpenChange(index, open)}>
                                          ...
                                          <CommandGroup>
                                            {applianceOptions.map((app) => (
                                              <CommandItem
                                                ...
                                                key={app.name}
                                                onSelect={() => {
                                                  handleApplianceSelect(app.name, index);
                                                }}
                                              >
                                                <Check
                                                  className={cn(
                                                    "mr-2 h-4 w-4",
                                                    app.name === field.value
                                                      ? "opacity-100"
                                                      : "opacity-0"
                                                  )}
                                                />
                                            ...
                                            <CommandItem
                                                onSelect={() => addCustomAppliance(index)}>
    ...
    return (
        <>
            ...
            <div className="flex-shrink-0 flex justify-end gap-2 p-6 border-t bg-background">
                ...
                <Button onClick={handleDownloadPdf} disabled={isGenerating} className="bg-accent text-accent-foreground hover:bg-accent/90">

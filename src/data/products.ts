  ...
  export const PRODUCTS: Product[] = [
    ...
    },
    {
      ...
      specifications: [
        { label: "BASIC PARAMETER", value: "" },
        { label: "Rated Voltage", value: "51.2V" },
        { label: "Nominal capacity", value: "119.6Ah | 6.123kWh" },
        { label: "ELECTRIC PARAMETER", value: "" },
        { label: "Charging modes", value: "CC/CV/CP" },
        { label: "Max. Charge Current", value: "80A" },
        { label: "Charging cut-off voltage", value: "57.4V" },
        { label: "Discharging modes", value: "CC/CP" },
        { label: "Discharging cut-off voltage", value: "44.8V" },
        { label: "Max. Discharge Current", value: "200A (1.5C continuous)" },
        { label: "Peak Discharge Current", value: "350A (100ms)" },
        { label: "BMS FUNCTIONS", value: "" },
        { label: "Protection", value: "Overvoltage & Undervoltage protection, Short-circuit protection, Low & High temperature charge protection, Low & High temperature discharge protection, Charge & Discharge over-current protection" },
        { label: "Features", value: "Dormancy function" },
        { label: "Communication", value: "RS485, CAN & RS232" },
        { label: "SIZE", value: "" },
        { label: "Dimensions", value: "438 x 536 x 220.6mm" },
        { label: "Weight", value: "about 57kg" },
        { label: "ENVIRONMENT", value: "" },
        { label: "Humidity", value: "5% to 95% RH, Non-condensing" },
        { label: "Operating Temperature", value: "Charge: 0~+55°C/Discharge: -20~+60°C" },
        { label: "Storage Temperature", value: "-20~+45°C (3 months) / -20~+25°C (1 year)" },
    ...
    },
    {
      ...
      specifications: [
        ...
        { label: "System Weight", value: "94Kg" },
        { label: "Dimension", value: "550x280x610 mm (Stackable)" },
        { label: "Optional Colour", value: "White, Green" },
        { label: "Calendar", value: "10 year (in condition)" },
        { label: "ELECTRICAL", value: "" },
        { label: "Energy Capacity", value: "10.24kWh" },
        { label: "Usable Capacity", value: "9.22kWh" },
        { label: "Depth of Discharge (DOD)", value: "90%" },
        { label: "Nominal Voltage", value: "51.2V" },
        { label: "Operating Voltage Range", value: "43.2V – 58.4V" },
        { label: "OPERATION", value: "" },
        { label: "Constant Charging Current", value: "100A (40A recommended)" },
        { label: "Max. Charging Current", value: "110A" },
        { label: "Constant Discharging Current", value: "150A (100A recommended)" },
        { label: "Max. Discharging Current", value: "160A" },
        { label: "Standard Charging Power", value: "5000W" },
        { label: "Max. Charging Power", value: "6500A" },
        { label: "Standard Discharging Power", value: "7500A" },
        { label: "Max. Discharging Power", value: "9000W" },
        { label: "Discharging Temperature Range", value: "-20°C ~ 60°C" },
        { label: "Charging Temperature Range", value: "0°C ~ 55°C" },
        { label: "Storage Temperature Range", value: "-20 °C ~ 45 °C" },
        { label: "Humidity", value: "10% ~ 95% RH" },
        { label: "BMS", value: "" },
        { label: "Modules Inter-Connection", value: "1-8 Parallel" },
        { label: "Monitoring Parameters", value: "System Voltage, current, temperature, PCBS temperature" },
        { label: "Communication", value: "RS485/ CAN/ RS232" },
        { label: "COMPATIBILITY", value: "" },
        { label: "Compatible Inverters", value: "Greenrich, Solis, Deye, Sunsynk, Growatt, Lux Power, Goodwe, East, SMA, Victron, Voltron, Chisage, Must, SofarSolar, Solarfam, Solax, Megarevo, VoltronicPower, SRNE, Pylon Tech, SAJ, Kehua, Sermatec, etc" }
      ],
    ...
    },
    {
      ...
      specifications: [
        ...
        { label: "Recommended max. PV power", value: "9.6KW" },
        { label: "Max. input voltage", value: "600V" },
        { label: "Rated voltage", value: "330V" },
        { label: "Start-up voltage", value: "90V" },
        { label: "MPPT voltage range", value: "90-520V" },
        { label: "Max. input current", value: "16A/ 16A" },
        { label: "Max. short circuit current", value: "24A/ 24A" },
        { label: "MPPT number/ Max. input", value: "2/2" },
        { label: "BATTERY", value: "" },
        { label: "Battery type", value: "Li-ion/Lead-acid" },
        { label: "Battery voltage range", value: "40-60V" },
        { label: "Max. charge/ discharge power", value: "6kW" },
        { label: "Max. charge/ discharge current", value: "135A" },
        { label: "Communication", value: "CAN/RS485" },
        { label: "OUTPUT AC (GRID SIDE)", value: "" },
        { label: "Rated output power", value: "6kW" },
        { label: "Max. apparent output power", value: "6.6kVA" },
        { label: "Operation phase", value: "1/N/PE" },
        { label: "Rated grid voltage", value: "220V/ 230V" },
        { label: "Rated grid frequency", value: "50 Hz/ 60Hz" },
        { label: "Rated grid output current", value: "27.3A/ 26.1A" },
        { label: "Max. output current", value: "30A" },
        { label: "Power factor", value: ">0.99 (0.8 leading- 0.8 lagging)" },
        { label: "THDi", value: "<2%" },
        { label: "OUTPUT AC (BACK-UP)", value: "" },
        { label: "Rated output power", value: "6kW" },
        { label: "Max. apparent output power", value: "2 times of rated power, 10s" },
        { label: "Back-up switch time", value: "<4 ms" },
        ...
        { label: "Max. input current", value: "40A" },
        { label: "Frequency range", value: "45-55 Hz/ 55-65 Hz" },
        { label: "EFFICIENCY", value: "" },
        { label: "Max. efficiency", value: ">97.5%" },
        { label: "EU efficiency", value: ">96.2%" },
        { label: "PROTECTION", value: "" },
        { label: "DC reverse-polarity protection", value: "Yes" },
        { label: "Ground fault monitoring", value: "Yes" },
        { label: "Integrated AFCI (DC arc-fault circuit protection)", value: "Yes" },
        { label: "Protection class/ Over voltage", value: "I/II" },
        { label: "GENERAL DATA", value: "" },
        { label: "Dimensions (WxHxD)", value: "406x560x205 mm" },
        { label: "Weight", value: "24kg" },
        { label: "Topology", value: "High frequency isolation (for battery)" },
        { label: "Operation ambient temperature range", value: "-40 ~ +60°C" },
        { label: "Ingress protection", value: "IP66" },
        { label: "Cooling protection", value: "Natural convection" },
        { label: "Max. Operation altitude", value: "4000 m" },
        { label: "Grid connection standard", value: "NRS 097-2-1, IEC 61727, 60068, IEC 61683, EN 50530, MEA, PEA" },
        { label: "Safety/EMC standard", value: "IEC/EN 62109-1/-2, EN 61000-6-2/-3" },
        { label: "FEATURES", value: "" },
        { label: "DC connection", value: "MC4 plug (PV port)/ Terminal Block (BAT port)" },
        { label: "AC connection", value: "Terminal Block" },
    ...
    },
    {
      ...
      specifications: [
        { label: "INPUT DC (PV SIDE)", value: "" },
        { label: "Recommended max. PV power", value: "12.8KW" },
        { label: "Max. input voltage", value: "600V" },
        { label: "Rated voltage", value: "330V" },
        { label: "Start-up voltage", value: "90V" },
        { label: "MPPT voltage range", value: "90-520V" },
        { label: "Max. input current", value: "32A/ 20A" },
        { label: "Max. short circuit current", value: "36A/ 30A" },
        { label: "MPPT number/ Max. input", value: "2/3" },
        { label: "BATTERY", value: "" },
        { label: "Battery type", value: "Li-ion/Lead-acid" },
        { label: "Battery voltage range", value: "40-60V" },
        { label: "Max. charge/ discharge power", value: "8kW" },
        { label: "Max. charge/ discharge current", value: "190A" },
        { label: "Communication", value: "CAN/RS485" },
        { label: "OUTPUT AC (GRID SIDE)", value: "" },
        { label: "Rated output power", value: "8kW" },
        { label: "Max. apparent output power", value: "8.8kVA" },
        { label: "Operation phase", value: "1/N/PE" },
        { label: "Rated grid voltage", value: "220V/ 230V" },
        { label: "Rated grid frequency", value: "50 Hz/ 60Hz" },
        { label: "Rated grid output current", value: "36.4A/ 34.8A" },
        { label: "Max. output current", value: "40A" },
        { label: "Power factor", value: ">0.99 (0.8 leading- 0.8 lagging)" },
        { label: "THDi", value: "<2%" },
        { label: "OUTPUT AC (BACK-UP)", value: "" },
        ...
        { label: "Rated output voltage", value: "1/N/PE, 220 V/ 230V" },
        { label: "Rated frequency", value: "50Hz/ 60Hz" },
        { label: "Rated output current", value: "36.4A/ 34.8A" },
        { label: "Max. output current", value: "40A" },
        { label: "THDv (@linear load)", value: "<2%" },
        { label: "INPUT AC (GRID SIDE)", value: "" },
        { label: "Input voltage range", value: "187-253 V" },
        { label: "Max. input current", value: "50A" },
        { label: "Frequency range", value: "45-55 Hz/ 55-65 Hz" },
        { label: "EFFICIENCY", value: "" },
        { label: "Max. efficiency", value: ">97.5%" },
        { label: "EU efficiency", value: ">96.2%" },
        ...
        { label: "Protection class/ Over voltage", value: "I/II" },
        { label: "GENERAL DATA", value: "" },
        { label: "Dimensions (WxHxD)", value: "406x560x215 mm" },
        { label: "Weight", value: "25.7kg" },
        { label: "Topology", value: "High frequency isolation (for battery)" },
        { label: "Operation ambient temperature range", value: "-40 ~ +60°C" },
        { label: "Ingress protection", value: "IP66" },
        { label: "Cooling protection", value: "Intelligent redundant fan-cooling" },
        { label: "Max. Operation altitude", value: "4000 m" },
        { label: "Grid connection standard", value: "NRS 097-2-1, IEC 61727, 60068, IEC 61683, EN 50530, MEA, PEA" },
        { label: "Safety/EMC standard", value: "IEC/EN 62109-1/-2, EN 61000-6-2/-3" },
        { label: "FEATURES", value: "" },

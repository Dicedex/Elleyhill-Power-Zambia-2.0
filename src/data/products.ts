...
export type Product = {
  ...
  export const PRODUCTS: Product[] = [
    ...
    },
    {
      ...
      category: "Batteries",
      description: "Reliable and efficient 5kWh battery storage from Greenrich, perfect for residential & business solar systems.",
    ...
    },
    {
        ...
        specifications: [
            ...
            { label: "Inverter", value: "Pure sine wave" },
            { label: "Output Port", value: "USB-A (5V 2.4A) x3\nTYPE-C (PD 60 W max ) x1\nAcX3 (2400W output power, 4000W surge Power)" },
